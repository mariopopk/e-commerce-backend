export default [
  {
    matched_terms: [],
    data: {
      id: "OUTRW00237-duffel green",
      url: "the-boulevard-bomber",
      stores: ["Bonobos"],
      swatches: [
        {
          on_sale: false,
      ...
      final_sale: false,
      description:
        "Bombers are always in style. Grab one if you want to look awesome. (Which should be always.)",
      is_gift_card: false,
      is_new_color: true,
      current_price: 189,
      number_of_fits: 0,
      ...
      variation_id: "BOT01535N1233GM",
    },
    value: "The Boulevard Bomber",
    is_slotted: false,
    labels: {},
  },
  {
